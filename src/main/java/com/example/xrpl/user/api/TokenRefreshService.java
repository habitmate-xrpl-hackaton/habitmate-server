...
public class TokenRefreshService {
    ...
    public String refreshAccessToken(String refreshToken) {
        ...
        return jwtTokenProvider.createAccessToken(user.getProviderKey(), user.getId(), user.getRole(), user.getXrplAddress(), user.getXrplSecret(), user.getIsKYC(), user.getIssuerAddress(), user.getCredentialType());
    }
}